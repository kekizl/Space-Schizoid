...
public class MapManager : MonoBehaviour {
  ...
  private void Start() {
    ...
    Vector3Int centerTile = new Vector3Int(4, 4, 0);
    Vector3Int cameraPos = new Vector3Int(4, 4, -10);
   ...
   // }
    ...
    Instantiate(Resources.Load<GameObject>("NPC"), new Vector3(0 + 5.5f, 0 + 2.5f, 0), Quaternion.identity).name = "NPC";
    Instantiate(Resources.Load<GameObject>("NPC"), new Vector3(0 - 5.5f, 0 - 2.5f, 0), Quaternion.identity).name = "NPC2";
